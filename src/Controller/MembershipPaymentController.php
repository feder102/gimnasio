...
{	
	...
	public function generatePaymentInvoice()
	{
		...
		{			
			...
			$start_date = date("m-d-Y",strtotime($this->request->data["membership_valid_from"]));
			$end_date = date("m-d-Y",strtotime($this->request->data["membership_valid_to"]));
	...
	public function addIncome()
    {
		...
		{	
			...
			$data["invoice_date"] = date("m-d-Y",strtotime($data["invoice_date"]));	
	...
	public function paymentSuccess()
	{
		...
		$feedata['paid_by_date']=date("m-d-Y");		
