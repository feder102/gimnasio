<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php
			...
			$url =  (isset($membership_data['gmgt_membershipimage']) && $membership_data['gmgt_membershipimage'] != "") ? $this->request->base ."upload/" . $membership_data['gmgt_membershipimage'] : $this->request->webroot ."upload/logo.png";
			echo "<img src='{$url}'>";
			echo "<br><br>";
