...
.panel-heading{
	height: 52px;
	background-color: rgb(192, 72, 36);;
	padding: 0 0 0 21px;
	margin: 0;
}
			...
			<a href="<?php echo $this->request->base ."/GymMember/memberList";?>">
				<div class="panel info-box panel-white">
					<div class="panel-body member">
						<img src="<?php echo $this->request->base;?>/img/dashboard/member.png" class="dashboard_background">
			...
			<a href="<?php echo $this->request->base ."/staff-members/staff-list";?>">
				<div class="panel info-box panel-white">
					<div class="panel-body staff-member">
						<img src="<?php echo $this->request->base;?>/img/dashboard/staff-member.png" class="dashboard_background">
                        <div class="info-box-stats">
			...
			<a href="<?php echo $this->request->base ."/gym-group/group-list";?>">
				<div class="panel info-box panel-white">
					<div class="panel-body group">
						<img src="<?php echo $this->request->base;?>/img/dashboard/group.png" class="dashboard_background">
			...
			<a href="<?php echo $this->request->base ."/gym-message/inbox";?>">
				<div class="panel info-box panel-white">
					<div class="panel-body message no-padding">
						<img src="<?php echo $this->request->base;?>/img/dashboard/message.png" class="dashboard_background_message">
						<div class="info-box-stats">
			...
			<div class="col-md-4 membership-list <?php echo $pull;?> col-sm-4 col-xs-12">
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						foreach($membership as $ms)
						{
							...
							?>
							<p>
								<img src="<?php echo $this->request->base ."/upload/" .$m_img; ?>" height="40px" width="40px" class="img-circle">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						?>
							<p>
								<img src="<?php echo $this->request->base ."/upload/" .$image; ?>" height="40px" width="40px" class="img-circle">
								<?php echo $gd["name"];?>
							</p>
						<?php
						} ?>
