<div class="container-gym">
  <div class="info">
    <h1 style="color: black;"><?php echo $this->Gym->getSettings("name");?></h1>
  </div>
</div>
<?php 
$logo =$this->Gym->getSettings("gym_logo");
$logo = (!empty($logo)) ? $this->request->base ."/upload/" . $logo : $this->request->base ."/img/Thumbnail-img2.png";
?>
<div class="form">
 ...
 <!-- <form class="register-form">
  ...
  <?php //echo $this->Form->create(["class"=>"login-form","method"=>"post","action"=>"GymLogin/index"]);?>
    ...
    <button id="btn_login"><?php echo __("Ingresar");?></button>
   <p class="message"><a href="<?php echo $this->request->base;?>/MemberRegistration/"><?php echo __("Registarse");?></a>
