	...
	<div class="col-md-12 box box-default">		
		...
		<?php
		  ...
		  <?php } ?>	
			...
			// $format = ["F j, Y"=>date("F j, Y"),"Y-m-d"=>date("m-d-Y"),"m/d/Y"=>date("m/d/Y"),"d/m/Y"=>date("d/m/Y")]; 18-11-2017
			$format = ["F j, Y"=>date("F j, Y"),"d-m-Y"=>date("m-d-Y"),"d/m/Y"=>date("d/m/Y")];
			...
			echo "<img src='{$this->request->webroot}upload/{$src}'><br><br><br>";
			echo "</div>";
			...
			echo "<img src='{$this->request->webroot}upload/{$src}'>";			
			echo "</fieldset><br><br>";
