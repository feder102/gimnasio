...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class="box-body">			
			...
			echo $this->Form->input("",["label"=>false,"name"=>"first_name","class"=>"form-control ","value"=>(($edit)?$data['first_name']:'')]);
			echo "</div>";	
			echo "</div>";	
			...
			echo "<br><img src='{$this->request->webroot}upload/{$image}' style='height: 30%;width: 30%;'>";
			echo "</div>";	
			echo "</div>";			
			echo "</fieldset>";
