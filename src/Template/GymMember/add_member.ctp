...
$i_date = date("m-d-Y",strtotime($inquiry_date));
$inquiry_date = (($i_date != '01-01-1970' && $inquiry_date != '' )?$inquiry_date:'');

$trial_end_date = (($edit)?$data['trial_end_date']:'');
$t_date = date("m-d-Y",strtotime($trial_end_date));
$trial_end_date = (($t_date != '01-01-1970' && $trial_end_date != '' )?$trial_end_date:'');

$first_pay_date = (($edit)?$data['first_pay_date']:'');
$p_date = date("m-d-Y",strtotime($first_pay_date));
$first_pay_date = (($p_date != '01-01-1970' && $first_pay_date != '' )?$first_pay_date:'');
...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php				
			...
			echo "<a href='/GymGroup/addGroup/' class='btn btn-flat btn-default'>".__("Add Group")."</a>";
			echo "</div>";	
			echo "</div>";
			echo "</fieldset>";
