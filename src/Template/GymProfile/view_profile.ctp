...
$profile_img = (!empty($profile_img)) ? $this->request->base ."/upload/". $profile_img : $this->request->base ."/img/Thumbnail-img.png";
	...
	<div id="main-wrapper"> 
		<div class="row">
			<div class="col-md-3 user-profile">
				...
				<p></p></li>
				<li><?php echo $this->Qr->text($data['member_id']);?></li>
				</ul>
							</div>			
				...
				<div class="panel-heading">
						...
						<form class="form-horizontal" action="#" method="post" id="doctor_form">							
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input id="birth_date" class="form-control validate[required] hasDatepicker" type="text" name="birth_date" value="<?php echo $data["birth_date"]->format("m-d-Y");?>">
								</div>
							</div>	
