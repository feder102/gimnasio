...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2019 at 10:13 AM
...
(1, 'GYM Management System', '2019', 'address', '8899665544', 'us', 'nayrevil@gmail.com', 'F j, Y', 'en', '', '', 'KG', 'Centimeter', 'Inches', 'Inches', 'Inches', 'Inches', 'Percentage', 0, 1, 0, 'your_id@paypal.com', 'USD', 1, '5', 'Hello GYM_MEMBERNAME,\r\n      Your Membership  GYM_MEMBERSHIP  started at GYM_STARTDATE and it will expire on GYM_ENDDATE.\r\nThank You.', 1, 'GYM MASTER', 'Copyright © 2016-2017. All rights reserved.', 1, 0, 'en', 'UTC', '12', 'en');
...
(1, 'StaffMembers', '', 'staff_member', 'staff-member.png', 'Staff Members', 1, 1, 1, '/gym/staff-members/staff-list'),
(2, 'Membership', '', 'membership', 'membership-type.png', 'Membership Type', 1, 1, 0, '/gym/membership/membership-list'),
(3, 'GymGroup', '', 'group', 'group.png', 'Group', 1, 1, 0, '/gym/gym-group/group-list'),
(4, 'GymMember', '', 'member', 'member.png', 'Member', 1, 1, 1, '/gym/gym-member/member-list'),
(5, 'Activity', '', 'activity', 'activity.png', 'Activity', 1, 1, 0, '/gym/activity/activity-list'),
(6, 'ClassSchedule', '', 'class-schedule', 'class-schedule.png', 'Class Schedule', 1, 1, 0, '/gym/class-schedule/class-list'),
(7, 'GymAttendance', '', 'attendance', 'attendance.png', 'Attendance', 0, 1, 0, '/gym/gym-attendance/attendance'),
(8, 'GymAssignWorkout', '', 'assign-workout', 'assigne-workout.png', 'Assigned Workouts', 1, 1, 0, '/gym/gym-assign-workout/workout-log'),
(9, 'GymDailyWorkout', '', 'workouts', 'workout.png', 'Workouts', 1, 1, 0, '/gym/gym-daily-workout/workout-list'),
(10, 'GymAccountant', '', 'accountant', 'accountant.png', 'Accountant', 1, 1, 1, '/gym/gym-accountant/accountant-list'),
(11, 'MembershipPayment', '', 'membership_payment', 'fee.png', 'Fee Payment', 1, 0, 1, '/gym/membership-payment/payment-list'),
(12, 'MembershipPayment', '', 'income', 'payment.png', 'Income', 0, 0, 1, '/gym/membership-payment/income-list'),
(13, 'MembershipPayment', '', 'expense', 'payment.png', 'Expense', 0, 0, 1, '/gym/membership-payment/expense-list'),
(14, 'GymProduct', '', 'product', 'products.png', 'Product', 0, 1, 1, '/gym/gym-product/product-list'),
(15, 'GymStore', '', 'store', 'store.png', 'Store', 0, 1, 1, '/gym/gym-store/sell-record'),
(16, 'GymNewsletter', '', 'news_letter', 'newsletter.png', 'Newsletter', 0, 1, 0, '/gym/gym-newsletter/setting'),
(17, 'GymMessage', '', 'message', 'message.png', 'Message', 1, 1, 1, '/gym/gym-message/compose-message'),
(18, 'GymNotice', '', 'notice', 'notice.png', 'Notice', 1, 1, 1, '/gym/gym-notice/notice-list'),
(19, 'GymNutrition', '', 'nutrition', 'nutrition-schedule.png', 'Nutrition Schedule', 1, 1, 0, '/gym/gym-nutrition/nutrition-list'),
(20, 'GymReservation', '', 'reservation', 'reservation.png', 'Reservation', 1, 1, 1, '/gym/gym-reservation/reservation-list'),
(21, 'GymProfile', '', 'account', 'account.png', 'Account', 1, 1, 1, '/gym/GymProfile/view_profile'),
(22, 'GymSubscriptionHistory', '', 'subscription_history', 'subscription_history.png', 'Subscription History', 1, 0, 0, '/gym/GymSubscriptionHistory/'),
(23, 'Reports', '', 'report', 'report.png', 'Report', 0, 1, 1, '/gym/reports/membership-report');
...
(1, NULL, 'administrator', NULL, 'Admin', '', '', NULL, NULL, NULL, 'male', '2016-07-01', NULL, NULL, 'null', 'null', 't', '123123', '123123123', '', 'admin@admin.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin', '$2y$10$bvA4oXvDFEy5gmRSgurLQOipACMgu4qcGC.N/dkgszKVLeCpLaRkG', 'logo.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2019-08-11', NULL),
